    ...
    return (
        <div className="m-6 p-6 pt-4 bg-gray-800 rounded-xl">
            ...
            <div className="pt-5 text-white text-lg font-normal text-justify">
                ...
                <br />
                <p className="text-xl font-extrabold tracking-tight mb-2" style={{color:color}}>
                    FAQ's
                </p>
                <hr className="dark:border-gray-600"/>
                
                <p className="text-base font-extrabold tracking-tight text-white mt-5">
                    - ¿Para qué es esto?
                </p>
                <p className="text-base font-medium tracking-tight text-white">
                ...
                <hr className="dark:border-gray-600"/>
                <p className="text-base font-medium tracking-tight text-white mt-5">
